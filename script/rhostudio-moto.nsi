...
section
    ...
    MessageBox MB_OK|MB_ICONINFORMATION|MB_DEFBUTTON1 "RhoMobile Suite already installed on this computer. If you want reinstall it run uninstall from program menu before."
    Quit 
